...
import android.view.*
import kotlinx.android.synthetic.main.layout_floating_view.view.*
...
class SimpleFloatingWindow constructor(private val context: Context) {
    ...
    private var floatView: View =
        LayoutInflater.from(context).inflate(R.layout.layout_floating_view, null)
    ...
    init {
        with(floatView) {
            ...
            textView.text = context.getString(R.string.main_text)
        }
